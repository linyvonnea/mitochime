...
\begin{frame}{Real-World Problem}
  ...
  \begin{figure}
  \centering
    \includegraphics[height=0.7\textheight]{../figures/slide6.JPG}
  \end{figure}
\end{frame}
...
\begin{frame}{Real-World Problem}
  ...
  \begin{figure}
  \centering
    \includegraphics[height=0.75\textheight]{../figures/slide6.JPG}
  \end{figure}
\end{frame}
...
\begin{frame}{Existing Approaches}
  \centering
  {\small {Table: Summary of Chimera Detection Approaches and Tools}}\\[0.3em]
  \begin{figure}
    \centering
    \includegraphics[height=0.75\textheight]{../figures/table.JPG}
  \end{figure}
\end{frame}
