...
Comparative testing was performed across classical machine learning and deep learning models to determine the most suitable classifier configurations for pipeline integration. Rather than selecting a classifier based only on a single metric, models were compared using multiple criteria: read-level classification performance, ROC--AUC, precision--recall behavior, runtime, interpretability, read retention after filtering, and downstream assembly graph effects. This allowed the study to distinguish between the best classifier for predictive performance, the most practical classifier for deployment, and the classifier that produced the strongest assembly simplification under selected external testing conditions.
